            ...
            foreach($query_data as $val) {
                ...
                $response['data'][] = [
                    ...
                    '
                        ...
                        <a href="'.env('APP_URL').'/invoice/print/'.CustomHelper::encrypt($val->code).'" class="btn btn-info btn-sm content-icon" data-toggle="tooltip" data-placement="top" title="Tooltip on top"><i class="fa fa-print"></i></a>
