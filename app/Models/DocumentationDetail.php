...
class DocumentationDetail extends Model
{
    use HasFactory, Notifiable, SoftDeletes;

    protected $table = 'documentation_details';
    ...
    public function documentation(){
        return $this->belongsTo('App\Models\Documentation','documentation_id','id')->withTrashed();
    }
