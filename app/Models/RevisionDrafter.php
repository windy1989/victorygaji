...
class RevisionDrafter extends Model
{
    use HasFactory, Notifiable, SoftDeletes;

    protected $table = 'revision_drafters';
    ...
    public function revisionDrafterDetail(): mixed{
        return $this->hasMany('App\Models\RevisionDrafterDetail');
    }
}