        ...
        ***********************************-->
		...
		<style>
            ...
            @media (min-width: 500px){
                #andalalin-datatable td:nth-of-type(1), #andalalin-datatable td:nth-of-type(2), #andalalin-datatable td:nth-last-of-type(1) {
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                ...
                                <div>	
                                    ...
                                    <button type="button" class="btn btn-primary mb-2" onclick="loadDataTableAndalalin();">Refresh</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="andalalin-datatable" class="display nowrap" style="min-width: 100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Kode Dokumen</th>
