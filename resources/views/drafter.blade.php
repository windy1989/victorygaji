        ...
        ***********************************-->
		...
		<style>
            ...
            @media (min-width: 500px){
                #drafter-datatable td:nth-of-type(1), #drafter-datatable td:nth-of-type(2), #drafter-datatable td:nth-last-of-type(1) {
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                ...
                                <div>	
                                    ...
                                    <button type="button" class="btn btn-primary mb-2" onclick="loadDataTableDrafter();">Refresh</button>
                                </div>
                            </div>
                            <div class="card-body">
