            ...
            <div class="dlabnav-scroll">
				...
				<ul class="metismenu" id="menu">
                    <li class="{{ Request::segment(2) == 'dashboard' ? 'mm-active' : '' }}">
                        <a href="{{ url('admin/dashboard') }}" class="{{ Request::segment(2) == 'dashboard' ? 'mm-active' : '' }}" aria-expanded="false">
                            <i class="flaticon-025-dashboard"></i>
                            <span class="nav-text">Dashboard</span>
                        </a>
                    </li>
					
                    <li class="{{ Request::segment(2) == 'file_manager' ? 'mm-active' : '' }}">
                        <a href="{{ url('admin/file_manager') }}" class="{{ Request::segment(2) == 'file_manager' ? 'mm-active' : '' }}" aria-expanded="false">
							<i class="flaticon-381-file-1"></i>
							<span class="nav-text">File Manager</span>
						</a>
					</li>

					<li class="{{ Request::segment(2) == 'user_manager' ? 'mm-active' : '' }}">
                        <a href="{{ url('admin/user_manager') }}" class="{{ Request::segment(2) == 'user_manager' ? 'mm-active' : '' }}" aria-expanded="false">
