        ...
        ***********************************-->
		...
		<style>
            ...
            @media (min-width: 500px){
                #mitigation-datatable td:nth-of-type(1), #mitigation-datatable td:nth-of-type(2), #mitigation-datatable td:nth-last-of-type(1) {
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                ...
                                <div>	
                                    ...
                                    <button type="button" class="btn btn-primary mb-2" onclick="loadDataTableMitigation();">Refresh</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="mitigation-datatable" class="display nowrap" style="min-width: 100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Kode Dokumen</th>
        ...
        <div class="modal fade" id="modalUpload">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Form Upload Kelengkapan Dokumen <b id="modal-detail-title-upload"></b></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal">
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <form action="{{ Request::url() }}/upload" class="dropzone mt-3" id="dropzone-upload-document">
                            @csrf
                        </form>
                        <div class="row mt-3">
