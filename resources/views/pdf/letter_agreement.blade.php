...
<html lang="en">
	<head>
		...
		<style>
            ...
            footer { position: fixed; bottom: -25px; left: 50px; right: 0px; height: 50px;font-size:13px; }
				...
				<tr>
                    ...
                    <td width="25%">
                        @if ($data->project->customer->logo)
                            <img src="{{ public_path('storage/'.$data->project->customer->pathLogoFromPublic()) }}" width="100px" height="auto" style="margin-left:65px;position:absolute;">
                        @else
            ...
            <div class="invoice-box">
                ...
                <table class="table-content" cellpadding="0" cellspacing="0" width="90%" style="margin:auto;text-align:justify;">
                    ...
                    <tr>
                        ...
                        <td>
                            {{ ($data->land_area > 0 ? $data->land_area : 'Belum diidentifikasi').', '.($data->building_area > 0 ? $data->building_area : 'belum diidentifikasi') }}
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <div style="margin:auto;width:90%;text-align:justify !important;">
                    ...
                    <p>
                        <ol type="1">
                            <li>
                                Pekerjaan penyusunan Dokumen ini hingga siap untuk diajukan ke Dinas akan diselesaikan dalam waktu {{ $data->days_to_finish }} ( {{ CustomHelper::terbilang($data->days_to_finish) }} ) Hari Kerja sejak diterimanya DP ( Down Payment ) dan berkas persyaratan ANDALALIN dengan lengkap yaitu pada tanggal {{ CustomHelper::tgl_indo($data->estimate_date_start) }} sampai dengan tanggal {{ CustomHelper::tgl_indo($data->estimate_date_finish) }}.
                            </li>
                        </ol>
                    </p>
                </div>
