                  ...
                  <td class="content-cell">
                    ...
                    <table class="body-action" width="100%" cellpadding="0" cellspacing="0" border="1">
                      ...
                      <tr style="background-color:#d1f3dd;">
                        ...
                        <td align="center">{{ number_format($data['jumlah_lembur'],'2',',','.') }}</td>
                        <td align="right">{{ number_format($data['total_lembur'],'2',',','.') }}</td>
                      </tr>
                      ...
                      <tr style="background-color:#d1f3dd;">
                        ...
                        <td align="center">-</td>
                        <td align="right">{{ number_format($data['tunjangan_pengganti'],'2',',','.') }}</td>
                      </tr>
