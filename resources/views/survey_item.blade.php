        ...
        ***********************************-->
		...
		<style>
            ...
            @media (min-width: 500px){
                #survey-item-datatable td:nth-of-type(1), #survey-item-datatable td:nth-of-type(2), #survey-item-datatable td:nth-last-of-type(1) {
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                ...
                                <div>	
                                    ...
                                    <button type="button" class="btn btn-primary mb-2" onclick="loadDataTableSurveyItem();">Refresh</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="survey-item-datatable" class="display nowrap" style="min-width: 100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Kode Dokumen</th>
                        ...
                        <form id="formData">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Item" id="name" name="name">
                                </div>
                                <div class="mb-3 col-md-6">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ Request::url() }}/upload" class="dropzone mt-3" id="dropzone-upload-small">
                            @csrf
                        </form>
                        <div class="row mt-3">
