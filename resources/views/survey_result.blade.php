        ...
        ***********************************-->
		...
		<style>
            ...
            @media (min-width: 500px){
                #survey-result-datatable td:nth-of-type(1), #survey-result-datatable td:nth-of-type(2), #survey-result-datatable td:nth-last-of-type(1) {
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                ...
                                <div>	
                                    ...
                                    <button type="button" class="btn btn-primary mb-2" onclick="loadDataTableSurveyResult();">Refresh</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="survey-result-datatable" class="display nowrap" style="min-width: 100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Kode Dokumen</th>
