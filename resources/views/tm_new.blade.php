        ...
        ***********************************-->
		...
		<style>
            ...
            @media (min-width: 500px){
                #tm-new-datatable td:nth-of-type(1), #tm-new-datatable td:nth-of-type(2), #tm-new-datatable td:nth-last-of-type(1) {
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                ...
                                <div>	
                                    ...
                                    <button type="button" class="btn btn-primary mb-2" onclick="loadDataTableTmNew();">Refresh</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tm-new-datatable" class="display nowrap" style="min-width: 100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Kode Dokumen</th>
